const footer = () => {
  return (
    <footer className="flex flex-col items-center mt-40 bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
      ...
      <div className="w-full bg-black/5 p-4 text-center">
        © 2024 Copyright
        <a href="https://tw-elements.com/"> Heavy Equipment</a>
      </div>
    </footer>
  );
};
